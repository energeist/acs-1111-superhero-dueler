...
def test_ability_name():
    ...
    big_strength = Ability("Overwhelming Strength", 300)
    assert big_strength.ability_name == "Overwhelming Strength"
...
def test_hero_add_ability():
    ...
    assert Athena.abilities[0].ability_name == "Overwhelming Strength"
...
def test_hero_weapon_equip():
    ...
    assert sans.abilities[0].ability_name == "Garlic Hot Sauce"
...
def test_team_hero():
    ...
    assert team.heroes[0].hero_name == "Jodie Foster"
